...
class BrandWebScreen extends StatefulWidget {
  const BrandWebScreen({super.key});

  @override
  State<BrandWebScreen> createState() => _BrandWebScreenState();
}

class _BrandWebScreenState extends State<BrandWebScreen> {
  final TextEditingController emailController = TextEditingController();
  int _rowsPerPage = 5;

  final List<Brand> _items = [
    Brand('Hii', 0),
    Brand('Shakeeb', 0),
    Brand('New', 0),
    Brand('Gass', 1),
...
class ItemDataSource extends DataGridSource {
  ...
  ItemDataSource(List<Brand> items)
      : _dataGridRows = items
      .map(
        (item) => DataGridRow(
      cells: [
