...
class BrandMobileScreen extends StatefulWidget {
  const BrandMobileScreen({super.key});

  @override
  State<BrandMobileScreen> createState() => _BrandMobileScreenState();
}

class _BrandMobileScreenState extends State<BrandMobileScreen> {
