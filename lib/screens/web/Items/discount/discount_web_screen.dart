...
class DiscountWebScreen extends StatefulWidget {
  const DiscountWebScreen({super.key});

  @override
  State<DiscountWebScreen> createState() => _DiscountWebScreenState();
}

class _DiscountWebScreenState extends State<DiscountWebScreen> {
