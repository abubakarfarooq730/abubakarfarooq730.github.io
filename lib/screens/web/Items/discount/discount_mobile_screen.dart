...
import 'package:sellio/models/discount_model.dart';
import 'package:syncfusion_flutter_datagrid/datagrid.dart';

import '../../../constants/create_new_button.dart';
import '../../../utils/custom_textform_field_withicon.dart';

class DiscountMobileScreen extends StatefulWidget {
  const DiscountMobileScreen({super.key});

  @override
  State<DiscountMobileScreen> createState() => _DiscountMobileScreenState();
}

class _DiscountMobileScreenState extends State<DiscountMobileScreen> {
  final TextEditingController emailController = TextEditingController();
  int _rowsPerPage = 5;

  final List<Discount> _items = [
    Discount('Azadi Discount', '15%', 'Percentage'),
    Discount('', '20%', 'Percentage'),
    Discount('D', '20%', 'Amount'),
    Discount('Eid Offer', '20%', 'Percentage'),
  ];
...
class ItemDataSource extends DataGridSource {
  ...
  ItemDataSource(List<Discount> items)
      : _dataGridRows = items
            .map(
              (item) => DataGridRow(
                cells: [
