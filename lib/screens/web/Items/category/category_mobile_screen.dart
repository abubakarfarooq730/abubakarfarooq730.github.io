...
class CategoryMobileScreen extends StatefulWidget {
  const CategoryMobileScreen({super.key});

  @override
  State<CategoryMobileScreen> createState() => _CategoryMobileScreenState();
}

class _CategoryMobileScreenState extends State<CategoryMobileScreen> {
...
class Item {
  ...
  Item(this.title, this.count);
}

class ItemDataSource extends DataGridSource {
  List<DataGridRow> _dataGridRows;

  ItemDataSource(List<Item> items)
      : _dataGridRows = items
      .map(
        (item) => DataGridRow(
      cells: [
        DataGridCell<String>(columnName: 'Title', value: item.title),
        DataGridCell<int>(columnName: 'Number of Items', value: item.count),
      ],
    ),
  )
      .toList();
