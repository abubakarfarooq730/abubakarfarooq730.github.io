...
class SalesReturnReportMobileScreen extends StatefulWidget {
  const SalesReturnReportMobileScreen({super.key});

  @override
  State<SalesReturnReportMobileScreen> createState() =>
      _SalesReturnReportMobileScreenState();
}

class _SalesReturnReportMobileScreenState extends State<SalesReturnReportMobileScreen> {
  late SalesReportDataSource _saleReportDataSource;

  @override
  void initState() {
    super.initState();
    _saleReportDataSource =
...
class SalesReportDataSource extends DataGridSource {
  ...
  SalesReportDataSource(List<SalesReturnReport> reports) {
