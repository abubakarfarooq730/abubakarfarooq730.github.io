...
class FooterDetailMobileScreen extends StatefulWidget {
  const FooterDetailMobileScreen({super.key});

  @override
  State<FooterDetailMobileScreen> createState() => _FooterDetailMobileScreenState();
}

class _FooterDetailMobileScreenState extends State<FooterDetailMobileScreen> {
