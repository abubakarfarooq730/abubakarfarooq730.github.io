...
class _SystemSettingsScreenState extends State<SystemSettingsScreen> {
  ...
  final TextEditingController purchaseInvoiceController = TextEditingController();
  final TextEditingController saleInvoiceController = TextEditingController();
  final TextEditingController quotationInvoiceController = TextEditingController();
                                    ...
                                    Row(
                                      children: [
                                        Radio(
                                          ...
                                          onChanged: (value) {
                                            setState(() {
                                              currencySymbolPosition = value.toString();
                                            });
                                          },
                                        ),
                                        const Text('Pre'),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        const Text('Show Previous Balance Due in Receipt'),
                                      ],
                                    ),
