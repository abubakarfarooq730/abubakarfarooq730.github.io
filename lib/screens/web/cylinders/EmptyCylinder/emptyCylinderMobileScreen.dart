...
class PurchasesMobileScreen extends StatefulWidget {
  const PurchasesMobileScreen({super.key});

  @override
  State<PurchasesMobileScreen> createState() => _PurchasesMobileScreenState();
}

class _PurchasesMobileScreenState extends State<PurchasesMobileScreen> {
